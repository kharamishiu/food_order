    ...
    menu: [
        {
            ...
            protein: 25,
            categories: "Burgers",
            menuCustomizations: ["Extra Cheese", "Coke", "Fries", "Onions", "Bacon"],
        },
        {
        ...
        },
        {
            ...
            protein: 18,
            categories: "Burritos",
            menuCustomizations: ["Jalapeños", "Iced Tea", "Fries", "Salad"],
        },
        {
            ...
            protein: 29,
            categories: "Burgers",
            menuCustomizations: ["Onions", "Fries", "Coke", "Bacon", "Avocado"],
        },
        {
            ...
            protein: 28,
            categories: "Wraps",
            menuCustomizations: ["Extra Cheese", "Coke", "Potato Wedges", "Tomatoes"],
        },
        {
            ...
            menuCustomizations: ["Mushrooms", "Olives", "Mozzarella Sticks", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 20,
            categories: "Wraps",
            menuCustomizations: ["Jalapeños", "Tomatoes", "Salad", "Fries", "Iced Tea"],
        },
        {
            ...
            protein: 24,
            categories: "Bowls",
            menuCustomizations: ["Avocado", "Sweet Corn", "Salad", "Iced Tea"],
        },
        {
        ...
        },
        {
            ...
            protein: 21,
            categories: "Pizzas",
            menuCustomizations: ["Extra Cheese", "Olives", "Coke", "Garlic Bread"],
        },
        {
            ...
            protein: 38,
            categories: "Bowls",
            menuCustomizations: ["Avocado", "Salad", "Sweet Corn", "Iced Tea"],
        },
        {
            name: "Paneer Burrito",
            ...
            protein: 22,
            categories: "Burritos",
            menuCustomizations: ["Jalapeños", "Fries", "Garlic Bread", "Coke"],
        },
        {
            ...
            protein: 31,
            categories: "Sandwiches",
            menuCustomizations: ["Bacon", "Tomatoes", "Mozzarella Sticks", "Iced Tea"],
        },
    ],
};
